...
## Task 1: Biological foundation of In Ovo Sexing

**Project Duration:** [Saturday, 27/09/2025] – [Sunday, 5/10/2025]  
**Objective:** Explore biological, technological, and practical aspects of in ovo sexing of chicken eggs, focusing on embryonic development, hemoglobin differences, and detection techniques.
...
#### 1. Biological Basis
- Structure and development stages of chicken eggs.  
- Differences in embryonic hemoglobin synthesis between male and female embryos.  
- Other potential biological markers for early sex differentiation (DNA, hormones).  

---

#### 2. Detection Techniques
- **Optical methods**: fluorescence spectroscopy, Raman spectroscopy, hyperspectral imaging.  
- **Molecular methods**: PCR, DNA-based sexing, hormone analysis.  
- **Non-invasive vs. invasive** approaches: benefits and drawbacks.  

---

#### 3. Accuracy and Efficiency
- Reported success rates of different techniques (e.g., ~96% with fluorescence).  
- Trade-offs between speed, accuracy, and practicality in large-scale hatcheries.  
- Potential of combining multiple methods (e.g., fluorescence + Raman).  

---

### ✅ Deliverables by Next Sunday
- Literature review notes.  
- Comparative tables of techniques.
- A timeline summary of the developement phase of chicken egg.



## Task 3: Dataset Identification and Machine Learning Model Application
